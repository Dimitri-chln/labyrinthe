...
execute as @a[scores={labyrinthe_players=1..4}] if score @s labyrinthe_players = current_player labyrinthe_labyrinthe_players_info run clear @s minecraft:magma_cream 1

# Check if the item is one of their card
## Broadcast message
execute if score current_player labyrinthe_labyrinthe_players_info matches 1 as @e[tag=labyrinthe_belongs_to_player_1,distance=..1] run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=1},limit=1]"}]}, " a trouvé une de ses cartes"]
execute if score current_player labyrinthe_labyrinthe_players_info matches 2 as @e[tag=labyrinthe_belongs_to_player_2,distance=..1] run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=2},limit=1]"}]}, " a trouvé une de ses cartes"]
execute if score current_player labyrinthe_labyrinthe_players_info matches 3 as @e[tag=labyrinthe_belongs_to_player_3,distance=..1] run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=3},limit=1]"}]}, " a trouvé une de ses cartes"]
execute if score current_player labyrinthe_labyrinthe_players_info matches 4 as @e[tag=labyrinthe_belongs_to_player_4,distance=..1] run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=4},limit=1]"}]}, " a trouvé une de ses cartes"]
...
execute if score current_player labyrinthe_players_info matches 1 unless entity @e[tag=labyrinthe_belongs_to_player_1] unless score player_1_found_all_cards labyrinthe_players_info matches 1 run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=1},limit=1]"}]}, " a trouvé toutes ses cartes !"]
execute if score current_player labyrinthe_players_info matches 1 unless entity @e[tag=labyrinthe_belongs_to_player_1] unless score player_1_found_all_cards labyrinthe_players_info matches 1 run scoreboard players set player_1_found_all_cards labyrinthe_players_info 1
execute if score current_player labyrinthe_players_info matches 2 unless entity @e[tag=labyrinthe_belongs_to_player_2] unless score player_2_found_all_cards labyrinthe_players_info matches 1 run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=2},limit=1]"}]}, " a trouvé toutes ses cartes !"]
execute if score current_player labyrinthe_players_info matches 2 unless entity @e[tag=labyrinthe_belongs_to_player_2] unless score player_2_found_all_cards labyrinthe_players_info matches 1 run scoreboard players set player_1_found_all_cards labyrinthe_players_info 1
execute if score current_player labyrinthe_players_info matches 3 unless entity @e[tag=labyrinthe_belongs_to_player_3] unless score player_3_found_all_cards labyrinthe_players_info matches 1 run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=3},limit=1]"}]}, " a trouvé toutes ses cartes !"]
execute if score current_player labyrinthe_players_info matches 3 unless entity @e[tag=labyrinthe_belongs_to_player_3] unless score player_3_found_all_cards labyrinthe_players_info matches 1 run scoreboard players set player_1_found_all_cards labyrinthe_players_info 1
execute if score current_player labyrinthe_players_info matches 4 unless entity @e[tag=labyrinthe_belongs_to_player_4] unless score player_4_found_all_cards labyrinthe_players_info matches 1 run tellraw @a[scores={labyrinthe_players=1..4}] [{"text": "[Labyrinthe] ", "color": "gray"}, {"text":"", "extra":[{"selector":"@a[scores={labyrinthe_players=4},limit=1]"}]}, " a trouvé toutes ses cartes !"]
execute if score current_player labyrinthe_players_info matches 4 unless entity @e[tag=labyrinthe_belongs_to_player_4] unless score player_4_found_all_cards labyrinthe_players_info matches 1 run scoreboard players set player_1_found_all_cards labyrinthe_players_info 1
